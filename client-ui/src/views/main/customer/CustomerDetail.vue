  ...
  <el-row>
    <el-col :xs="24" :md="12" class="mx-auto mb-4">
      <el-card :body-style="{ padding: '0px' }">
        ...
        <div style="padding: 14px" v-if="customer">
          <el-row
            :gutter="10"
            v-for="(item, index) in Object.entries(customer)"
            :key="index"
          >
          ...
          <div class="bottom">
            <el-button
              :data-test="customerDetailBackBtn"
              type="primary"
              @click="() => $router.go(-1)"
              icon="ArrowLeft"
...
onMounted(async () => {
  ...
  setCurrentPageBreadcrumbs("customers", ["detail"]);
});
</script>
<style>
.bottom {
