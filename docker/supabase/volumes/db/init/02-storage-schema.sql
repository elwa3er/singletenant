...
CREATE TABLE "storage"."buckets" (
    ...
    CONSTRAINT "buckets_owner_fkey" FOREIGN KEY ("owner") REFERENCES "auth_test"."users"("id"),
    PRIMARY KEY ("id")
);
...
CREATE TABLE "storage"."objects" (
    ...
    CONSTRAINT "objects_owner_fkey" FOREIGN KEY ("owner") REFERENCES "auth_test"."users"("id"),
    PRIMARY KEY ("id")
);
