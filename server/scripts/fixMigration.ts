...
const DEFAULT_SCHEMA_NAME = "public_test"
...
WHERE 
    tc.constraint_type = 'FOREIGN KEY' AND ccu.table_name = 'User' AND ccu.table_schema = 'public_test'
`
...
const main = async () => {
    const query = `ALTER TABLE "${DEFAULT_SCHEMA_NAME}"."TABLE_NAME" ALTER COLUMN "COLUMN_NAME" SET DEFAULT requesting_user_id()`
