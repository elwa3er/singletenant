...
import { AddressCreateManyInput } from "./AddressCreateManyInput";
...
import { AddressupdateManyArgs } from "./AddressupdateManyArgs";
...
import { getListAddressDto } from "./getListAddress.dto";
...
export class AddressControllerBase {
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async createMany(
    @common.Body() data: Array<AddressCreateManyInput>,
    @nestAccessControl.UserRoles() userRoles: string[]
  ...
  @swagger.ApiOkResponse({ type: getListAddressDto })
  ...
  async findMany(
    ...
    const result = results.paginatedResult.map((result: Address) =>
