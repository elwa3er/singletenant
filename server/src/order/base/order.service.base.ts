...
export class OrderServiceBase {
  ...
  async createMany<T extends Prisma.OrderCreateManyArgs>(
    args: Prisma.SelectSubset<T, Prisma.OrderCreateManyArgs>
  ): Promise<Prisma.BatchPayload> {
    return await this.prisma.order.createMany<T>(args);
  }
  ...
  async updateMany<T extends Prisma.OrderUpdateManyArgs>(
    args: Prisma.SelectSubset<T, Prisma.OrderUpdateManyArgs>
  ): Promise<Prisma.BatchPayload> {
    return await this.prisma.order.updateMany(args);
  }
